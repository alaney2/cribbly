    ...
    <>
      <div className="w-full py-6 space-y-6 md:py-12 justify-center flex">
        <div className="container grid max-w-3xl gap-6 px-4 text-sm md:gap-8 md:px-6">
          ...
          <div className="space-y-4">
            <p>
              At Cribbly, we take your privacy very seriously. It is our policy to respect your privacy regarding any information we may
            ...
            <Text>
              <Strong>
                By engaging with our Services in any capacity, you acknowledge and agree to the practices and policies detailed here. Your consent is given for the collection, utilization, and sharing of your information in accordance with the guidelines set forth in this Privacy Policy.
              </Strong>
            </Text>
            <Text className='font-medium'>
              Please note that your interaction with Cribbly&apos;s Services is consistently governed by our <Link href='/terms' className='text-blue-600'>Terms of Service</Link>. Terms used in this Policy, which are not defined here, carry their meanings as specified in the <Link href='/terms' className='text-blue-600'>Terms of Service</Link>.
            </Text>
          </div>
          <div className="space-y-4">
