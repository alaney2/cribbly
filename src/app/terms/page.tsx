				...
				<div className="space-y-8">
					<div className="space-y-2">
						...
						<p>
							...
							the use of Cribbly&apos;s website, located at https://cribbly.io.
						</p>
					</div>
					<div className="space-y-2">
						...
						<ul className="list-disc list-inside space-y-2">
							...
							<li>
								...
								Under these Terms, when we refer to &quot;You&quot; or
								&quot;Your,&quot; we are referring to You, the person accessing
								the Service and accepting these Terms.
							</li>
						</ul>
					</div>
					<div className="space-y-2">
						...
						<p>
							The User is responsible for the security of their account. Users
							must not share their accounts with anyone else. Users must also
							agree to accept all risks of unauthorized access to their data and
							any other information they provide to the Service.
						</p>
					</div>
					<div className="space-y-2">
						<h2 className="text-lg font-bold tracking-tight">
						...
						<p>
							...
							are and will remain the exclusive property of Example Website and
					...
					<div className="space-y-2">
						...
						<p>
							In no event shall Cribbly, nor its directors, employees, partners,
