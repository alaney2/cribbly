  ...
  return (
    <>
      <div className='h-full flex flex-col'>
        ...
        <div className="absolute left-64 top-4 overflow-hidden">
          <PropertyBreadcrumbs />
        </div>
        <div className="mx-auto flex w-full h-full items-start gap-x-6 lg:gap-x-8 py-4 lg:px-8 px-4 sm:px-6 lg:mt-8">
          ...
          <main className="flex-1 lg:bg-white lg:rounded-3xl lg:shadow-md lg:block lg:mr-8 p-2 md:p-8 overflow-auto content-container">
            {children}
          </main>
        </div>
      </div>
