...
type MobileTenantSidebarProps = {
  userEmail: string | undefined
  fullName: string | undefined | null
}

export function MobileTenantSidebar({ userEmail, fullName }: MobileTenantSidebarProps) {
  ...
  return (
    <>
      <div className="top-0 z-50 flex items-center justify-center gap-x-6 bg-gray-50 px-4 py-4 shadow-sm sm:px-6 lg:hidden">
        ...
        <Link href="/tenant-dashboard" className=''>
        ...
        <TenantProfileButton userEmail={userEmail} fullName={fullName} />
      </div>
