...
export function StackedLayout({
	...
	return (
		<div className="relative isolate flex min-h-svh w-full flex-col bg-gray-50 lg:bg-zinc-100 dark:bg-zinc-900 dark:lg:bg-zinc-950">
			{/* Sidebar on mobile */}
			...
			<main className="flex flex-1 flex-col pb-2 lg:px-2">
				<div className="grow p-6 lg:rounded-lg bg-gray-50 lg:bg-white lg:p-10 lg:shadow-sm lg:ring-1 lg:ring-zinc-950/5 dark:lg:bg-zinc-900 dark:lg:ring-white/10">
