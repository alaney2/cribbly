...
export const NavbarItem = forwardRef(function NavbarItem(
	...
	const classes = clsx(
		// Base
		"relative flex min-w-0 items-center gap-3 rounded-lg p-2 text-left text-base/6 font-medium text-zinc-950 sm:text-sm/5 cursor-default",
		...
		// Hover
		"data-[hover]:bg-zinc-950/5 data-[slot=icon]:*:data-[hover]:fill-zinc-950 cursor-default",
		// Active
