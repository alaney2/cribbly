	...
	useEffect(() => {
		...
		if (panel) {
			if (isClosing) {
				...
				panel.style.transition = isDragging
					? "none"
					: "transform 0.25s ease-out";
			}
		}
	}, [dragOffset, isDragging, isClosing]);

	return (
		<Headless.Dialog {...props} open={props.open && !isClosing}>
			...
			<div className="fixed inset-0 w-screen overflow-hidden pt-6 sm:pt-0">
