...
type DesktopTenantSidebarProps = {
  fullName: string | undefined | null
  sidebarCollapsed: boolean | null | undefined
}

export function DesktopTenantSidebar({ fullName, sidebarCollapsed }: DesktopTenantSidebarProps) {
  ...
  const navigation = [
    { name: 'Dashboard', href: getDashboardURL(), icon: ChartPieIcon },
  ...
  return (
    ...
    >
      {isSidebarCollapsed ? (
        <Link href="/tenant-dashboard" className="mt-6">
        ...
        <Link href="/tenant-dashboard" className="group mt-6 mb-1.5 flex items-center font-lexend gap-x-2 text-lg tracking-tight font-medium cursor-default rounded-2xl w-full select-none">
