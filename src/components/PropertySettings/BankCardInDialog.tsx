...
export function BankCardInDialog() {
	return (
		<>
			<Heading>Bank Account</Heading>
			<Text className="">
				Connect your bank account to receive payments from tenants. You can set
				different bank accounts for each property.
			</Text>
			<Headless.Field className="relative flex flex-col md:flex-row md:items-center md:gap-4 mt-4">
				<Label
					htmlFor="rentAmount"
