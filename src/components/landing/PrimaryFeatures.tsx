...
export function PrimaryFeatures() {
	...
	return (
		<section
			...
			className="relative overflow-x-hidden bg-blue-600 pb-28 pt-20 md:py-32"
			style={{
		...
		>
			<Container className="relative">
				...
				<div className="mt-16 grid grid-cols-1 items-center gap-y-2 pt-10 md:gap-y-6 md:mt-20 lg:grid-cols-12 lg:pt-0">
					<div className="-mx-4 flex overflow-x-scroll pb-4 md:mx-0 md:overflow-visible md:pb-0 lg:col-span-5">
						<div className="relative z-10 flex gap-x-4 whitespace-nowrap px-4 md:mx-auto md:px-0 lg:mx-0 lg:block lg:gap-x-0 lg:gap-y-1 lg:whitespace-normal">
								...
								<div
									...
									className={clsx(
										...
										selectedIndex === featureIndex
											...
											: "md:hover:bg-white/10 lg:hover:bg-white/5",
									)}
								>
									<h3>
										<button
											...
											className={clsx(
												...
												selectedIndex === featureIndex
													...
													: "text-blue-100 md:hover:text-white lg:text-white",
											)}
										>
									...
									<p
										className={clsx(
											...
											selectedIndex === featureIndex
												? "text-white"
												: "text-blue-100 md:group-hover:text-white",
										)}
									>
										{feature.description}
									</p>
					...
					<div className="lg:col-span-7">
						{features.map((feature, index) => (
							...
							>
								<div className="relative md:px-6 lg:hidden">
									<div className="absolute -inset-x-4 bottom-[-4.25rem] top-[-6.5rem] bg-white/10 ring-1 ring-inset ring-white/10 md:inset-x-0 sm:rounded-t-xl" />
									<p className="relative mx-auto max-w-2xl text-base text-white md:text-center">
										{feature.description}
									</p>
								</div>
								<div className="mt-10 overflow-hidden rounded-md md:rounded-2xl bg-gray-100 shadow-xl shadow-blue-900/20 md:w-auto lg:mt-0 w-[45rem] lg:w-[67.8125rem] pointer-events-none">
									<Image
