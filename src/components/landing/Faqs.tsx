  ...
  [
    {
      ...
      answer:
        "Your first property's on the house. To manage more properties, we charge a one-time fee of $78 for a lifetime license. That means all features and updates without annoying subscriptions.",
    },
    {
      question: "How do I start using Cribbly?",
      answer:
        "Sign up, add your properties, go through a quick verification with our payment processor, and invite your tenants. You're good to go!",
    },
    {
      question: "Can I manage properties on the go?",
      answer:
        "Cribbly is mobile-friendly, so you can handle everything from your phone or tablet. Whether you're at the beach or on the couch, your properties are at your disposal.",
    },
    {
      question: "What types of properties can be managed using Cribbly?",
      answer:
        "All types of properties like single-family homes, condos, or a 20-unit apartment building.",
    },
  ],
];
